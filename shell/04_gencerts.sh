...
./shell/04_ssl04_ca.sh
./shell/04_ssl04.01_admin.sh
...
for instance in kn1 kn2 kn3; do
  ...
  ./shell/04_ssl04.02_kubelet-client.sh ${instance} ${external_ip} ${internal_ip}
done

./shell/04_ssl04.03_controller-manager.sh
./shell/04_ssl04.04_kube-proxy.sh
./shell/04_ssl04.05_scheduler-client.sh
...
./shell/04_ssl04.06_api-server.sh ${lb_address}
./shell/04_ssl04.07_svcacct-keypair.sh
