...
for instance in kn1 kn2 kn3; do
  ...
  ./04_ssl/04.02_kubelet-client.sh ${instance} ${external_ip} ${internal_ip}
done

./04_ssl/04.03_controller-manager.sh
./04_ssl/04.04_kube-proxy.sh
./04_ssl/04.05_scheduler-client.sh
...
./04_ssl/04.06_api-server.sh ${lb_address}
./04_ssl/04.07_svcacct-keypair.sh
